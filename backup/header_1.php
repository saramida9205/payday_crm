    ...
    <div class="main-container"> <!-- This container wraps both sidebar and content -->
        <div class="sidebar" id="sidebar">
            <div class="sidebar-header">
                ...
                <a href="intranet.php" class="sidebar-logo"><img src="../uploads/company/logo.png" style="width: 90%; height: 40px;" alt="Payday CRM"></a>
            </div>
            ...
            <ul class="nav">
                ...
                <li><a href="sms.php" class="<?php echo in_array($current_page, ['sms.php', 'sms_log.php']) ? 'active' : ''; ?>">SMS관리</a></li>
                <li><a href="sms_log.php" class="<?php echo in_array($current_page, ['sms_log.php']) ? 'active' : ''; ?>">SMS 발송 내역</a></li>
                <li><a href="certificate_print.php" class="<?php echo in_array($current_page, ['certificate_print.php']) ? 'active' : ''; ?>">증명서 인쇄</a></li>
        ...
        <div class="main-content"> <!-- This class should match the CSS -->
            ...
            <div class="mobile-header" style="display: none;">
                ...
                <span class="mobile-title">Payday CRM</span>
