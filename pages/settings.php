...
<div class="form-container" style="max-width: 600px; margin-top: 20px;">
    <form action="../process/settings_process.php" method="post" id="system-settings-form" enctype="multipart/form-data">
        <input type="hidden" name="action" value="update_system_settings">

        <h4>회사 정보 설정</h4>
        <div class="form-col" style="margin-bottom: 15px;">
            <label for="company_name">회사명</label>
            <input type="text" name="company_name" id="company_name" class="form-control" value="<?php echo htmlspecialchars($company_name); ?>" placeholder="예: (주)테스트대부">
        </div>
        <div class="form-col" style="margin-bottom: 15px;">
